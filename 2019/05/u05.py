...
class Computer2:
    ...
    def asm_add(self, code):
        ...
        self.program[self.get_parameter(3, 1)] = self.get_parameter(1, ma) + self.get_parameter(2, mb)
        self.pc += 4
        return self
    ...
    def get_parameter(self, par, mode):
...
# test cases
testcase(Computer2(), '1002,4,3,4,33', 1002)
xxx
# 5182797
